...
public class Complaints_Fragment extends android.support.v4.app.Fragment {

    public ImageView complaint_list_sort;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view =inflater.inflate(R.layout.complaint_view,null);
        ...
        complaint_list_sort = (ImageView)view.findViewById(R.id.complaint_list_sort);
        ...
        complaint_list_sort.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                customAnimations();
            }
...
//                animations();
    ...
    private void implentOnOpenAnimations() {
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            //    complaint_list_sort.setImageResource(R.mipmap.closed);
                complaint_list_sort.setBackgroundResource(R.mipmap.closed);
    ...
    private void implementOnCloseAnimations() {
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
              ...
              //  complaint_list_sort.setImageResource(R.mipmap.sort_icon);
                complaint_list_sort.setBackgroundResource(R.mipmap.sort_btn);
